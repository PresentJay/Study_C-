...
#20143174 정현재
f = lambda x: 4*x-(1.8)*pow(x,2)+(1.2)*pow(x,3)-(0.3)*pow(x,4)  #주어진 함수
fp = lambda x:4-(3.6)*x+(3.6)*pow(x,2)-(1.2)*pow(x,3)           #1차 도함수
fpp = lambda x:(-3.6)+(7.2)*x-(3.6)*pow(x,2)                    #2차 도함수
R = (pow(5,(0.5))-1)/2  #황금비
